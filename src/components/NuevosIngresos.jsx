...
import { ClipboardCheck, Calendar, Star, Info, Pen, Lock, Unlock, ShieldCheck } from 'lucide-react'
...
const NuevosIngresos = ({ mes, semana, titulo, descripcion }) => {
    const { evaluaciones, updateEvaluacion, setPrintConfig } = useEvaluacion()
    ...
    const handleSaveFirma = () => {
        ...
        handleChange('firmaSemanal', sigCanvas.current.toDataURL())
    }

    const clearFirma = () => {
        updateEvaluacion(mes, semana, { firmaSemanal: null })
    }
